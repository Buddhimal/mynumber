        ...
        try {
            ...
            if ($check_auth_client == true) {
                ...
                if ($this->mlogin->is_valid()) {
                    ...
                    $location = $this->mlocations->get($clinic->location);

                    $clinic->location_city = $location->location_city;
                    $clinic->location_street_address = $location->location_street_address;
